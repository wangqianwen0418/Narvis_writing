...
\notsure{
The relationship between the 2 visual primitives, if there are two, are usually self-evident. We identify four types of relationships between visual units: none, spacial, temporal, and logical.  The encoding of one primitive always has a high dependency on the encoding of another primitive. For example, in a chord diagram, the encoding of the arcs should be explained before the line connecting them. 
}
