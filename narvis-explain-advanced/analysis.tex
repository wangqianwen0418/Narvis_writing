\begin{figure*}
 ...
 \caption{After decomposing OpinionSeer\cite{wu_opinionseer:_2010}, we obtain the hierarchical structure of this visualization. It consists of five visual units, and employs three kinds of visual primitives. }
...
%  \midrule
 \textbf{} &\textbf{Radial} &\textbf{Orthogonal, Align, Map} &\textbf{Metric-based}   \\ 
  \midrule
  \textbf{Dot} &Spiral&Dot Chart, Scatter Plot, Bubble Chart, Bubble Map &Circle packing\\
  \midrule
