...
We go through all the text visualizations collected in Kucher and Kerren's survey~\cite{kucher2015text}, and define four types of relationship that commonly exist between visual units: irrelevance, relevance, enhancement, and dependency. 
...
\noindent
\textbf{Sharing} refers to that two visual units share some visual grammar and it is a bi-directional relation. 
