...
It is, however, noteworthy that animation, in spite of all the advantages mentioned above, can bring about negative effects when used improperly~\cite{robertson_effectiveness_2008}. Based on the results of previous research \siwei{cite}, our work provides a guideline on how to implement animations in our system.
