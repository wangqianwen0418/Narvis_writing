...
Jessica has extensive experience in the field of data visualization, and she has released a visual analytics system online \siwei{doing something}. To help audience better understand her system, she needs to publish a tutorial accompanied with the system.
...
% After a few seconds, the system automatically detects graphics elements cluster them based on features \siwei{why to cluster?}. However, the results is not desirable.
