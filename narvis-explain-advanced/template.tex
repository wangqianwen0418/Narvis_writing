...
\keywords{Illustrative Visualization, Presentation, User Interface}
...
<<<<<<< HEAD
  \caption{Example of an introduction slide show of \textit{TextFlow}\cite{cui_textflow:_2011} produced by an expert in data visualization using Narvis. This slideshow illustrates the overview through a decompostion animation (the first line), introduces a visual unit (i.e. the stream graph) through revealing visual channels gradually (the second line), and introduces a visualization through constructing three visual units, a stream graph, a thread, and a glyph.}
=======
  \caption{Example of an introduction slideshow of \textit{TextFlow}\cite{cui_textflow:_2011} produced by Narvis. This slideshow consist of (a) a cover, (b) a decomposing animation, (c) a series of slides that introduces a visual unit through morphing, (d) a series of slides that introduces a visualization through constructing visual units.  \siwei{where is a, b, c, d in the figure?}}
>>>>>>> origin/master
	\label{fig:teaser}
}
