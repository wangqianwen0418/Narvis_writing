...
\teaser{
  ...
  \caption{Example of an introduction slide show of \textit{TextFlow}\cite{cui_textflow:_2011} produced by an expert in data visualization using Narvis. This slideshow consist of (a) a cover, (b) a decomposing animation, (c) a series of slides that introduces a visual unit through morphing, (d) a series of slides that introduces a visualization through constructing visual units.  }
	\label{fig:teaser}
}
